    ...
    return (
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            <form
                ...
                className="bg-white shadow-mdp rounded-lg py-10 px-5 mb-10">
                ...
                <input type="submit" className="hover:bg-indigo-700 cursor-pointer transition-all bg-indigo-600 w-full p-3 text-white uppercase font-bold"
